...
Make HEAVY use of the `gh` CLI. Features should ALWAYS be implemented as PRs to main, all features should be planned as GitHub issues. Always open PRs for new features for issues. ALWAYS assume that multiple coding agents will be working on features simultaneously.
