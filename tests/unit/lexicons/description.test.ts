...
import { $safeParse } from '../../../lib/lexicons/com/smellgate/description'
import { loadFixturesForRecord } from './_helpers'

const { valid, invalid } = loadFixturesForRecord('description')

describe('com.smellgate.description validator', () => {
